...
- `supplement.qmd` Running this file reproduces the supplementary
  documents including the tables and figures therein
...
- `/R` This directory contains the scripts used to produce the results
  ...
  iv\. `make-sims.R` Runs the files `simulations.R` and `simulations2.R`
  which contain the generation and modelling of the simulated data set
